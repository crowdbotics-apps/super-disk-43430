"""
Django settings for super_disk_43430 project.
...
ROOT_URLCONF = 'super_disk_43430.urls'
...
WSGI_APPLICATION = 'super_disk_43430.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "super_disk_43430 API",
    "DESCRIPTION": "API documentation for super_disk_43430 App",
    "VERSION": "v1",
}
